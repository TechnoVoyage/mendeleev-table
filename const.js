table_element_rel = [
  ...
  element_names = {
    ...
    24: ['Cr', 'Хром', 'Chromium'],
    25: ['Mn', 'Марганец', 'Manganese'],
    26: ['Fe', 'Железо', 'Iron'],
    27: ['Co', 'Кобальт', 'Cobalt'],
    28: ['Ni', 'Никель', 'Nickel'],
    29: ['Cu', 'Медь', 'Copper'],
    30: ['Zn', 'Цинк', 'Zinc'],
    31: ['Ga', 'Галлий', 'Gallium'],
    32: ['Ge', 'Германий', 'Germanium'],
    33: ['As', 'Мышьяк', 'Arsenic'],
